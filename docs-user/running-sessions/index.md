...
sidebar_position: 1
description: Guides for session operators — starting GAMA, preparing headsets, and running simulations.
---

# Running Sessions

This section covers everything needed to run a SIMPLE session end-to-end.
