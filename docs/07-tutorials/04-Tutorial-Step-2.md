---
sidebar_position: 4
title: "Step 2 — Set Up the Unity Scene"
sidebar_label: "2. Set Up the Unity Scene"
description: Open the Unity template and configure it to receive geometry data from the traffic model.
---
...
* You have correctly installed Unity and the required modules: **[Installation Guide](/unity/installation)**.
* You are familiar with the editor's layout: **[Unity Interface Basics](/unity/interface)**.
...
**Please follow the instructions in the [Running a Model Game guide](/unity/how-to/Running-a-model-game) to properly set up the simulator.**
:::

---

 **Next Step:** [Proceed to Step 3](./05-Tutorial-Step-3.md)