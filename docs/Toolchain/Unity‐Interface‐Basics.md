# 🖥️ Unity Interface & Navigation Basics
...
### ✈️ Fly Mode (First Person Style)
This is the most efficient way to move large distances.
1.  **Hold Right Click** inside the Scene View (your cursor turns into an eye 👁️).
...
>
> When you press the ▶️ **Play** button at the top to test the game, the editor enters "Play Mode".
