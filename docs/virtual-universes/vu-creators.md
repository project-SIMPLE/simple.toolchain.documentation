---
title: Virtual Universe Creator Guide
sidebar_label: Creator Guide
sidebar_position: 2
...
- A `settings.json` descriptor (required) — tells the WebPlatform the name, splashscreen, and which GAML experiment to launch. See [Understanding settings.json](./settings.md).
...
See the [GAML API Reference](../toolchain/gaml-api.md) for the full list of available species, operators, and actions.
...
See the [settings.json Reference](./settings.md) for all fields, path resolution rules, and catalog grouping.
