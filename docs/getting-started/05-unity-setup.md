...
:::note
Before starting, complete the [Unity installation](../toolchain/Unity-Installation-Guide.md) (Unity 6000.3.8f1 with Android Build Support modules).
:::
...
4. Unity Hub will warn if the editor version does not match — install `6000.3.8f1` if needed (see [Unity installation](../toolchain/Unity-Installation-Guide.md)).
...
- [GAML API Reference](../toolchain/gaml-api.md) — writing the GAMA side of your VU
- [Virtual Universe Creator Guide](../virtual-universes/vu-creators.md) — structuring your VU folder and `settings.json`
