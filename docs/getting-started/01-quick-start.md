...
|---|---|---|
| GAMA + SIMPLE plugin | GAMA 2025.06 | [GAMA setup](./02-dependencies.md#gama-platform) |
| WebPlatform | Node.js ≥ 22 | [WebPlatform install](./03-web-platform.md) |
| Unity template | Unity 6000.3.8f1 | [Unity setup](./05-unity-setup.md) |
| Headset connectivity | ADB (optional for dev) | [ADB setup](./02-dependencies.md#android-debug-bridge-adb) |
...
1. [Prerequisites](./02-dependencies.md) — GAMA, SIMPLE plugin, Node.js, ADB
2. [Install the WebPlatform](./03-web-platform.md)
3. [Install a Virtual Universe](./04-virtual-universe.md) (to have something to launch)
4. [Unity template setup](./05-unity-setup.md) — open the project, configure IP, run in editor
