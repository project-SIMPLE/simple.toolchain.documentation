...
Navigate to the SIMPLE web platform repository <br/>
...
1.Go to the repository homepage <br/>
2.Click the green "Code" button <br/>
3.Select "Download ZIP" <br/>
4.Ensure the "main" branch is selected before downloading <br/>
...
This can be done manually by copy-pasting the file and reremoving the last extension, or by using the following command
...
For more information on the .env file, check out this page 
:::warning
